  ...
  return (
    <main className="main">
      ...
      <p>
        ...
        l'hummanité pour les années à venir :
      </p>
      <p>
      ...
      <p>
        ...
        serre dans l'atmosphère. Ces gaz à effet de serre ont toujours existés
        dans l'atmosphère de façon de naturelle. Mais depuis quelques années, le
        plus dangereux des gaz à effet de serre (le Co2) a connu une une
        ...
        l'augmentation de ce phénomène : les industrie, les transports,
