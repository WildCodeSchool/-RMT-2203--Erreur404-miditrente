...
const faqData = [
  ...
  },
  {
    ...
    answer: `On considère que de dépassement de certains seuils  en matière de volume émis ou extrait de l’environnement sont responsable de perturbations significatives de la température globale, notamment une variation de plus de 0 W/m2 du forçage radiatif.\nLe forçage radiatif, appliqué au réchauffement climatique, mesure la propension d’un facteur, comme par exemple la concentration en gaz à effet de serre, à perturber l’équilibre énergétique de la Terre`,
    open: false,
  },
  {
    id: 4,
